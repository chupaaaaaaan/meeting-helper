...
var $author$project$Main$queryValueToList = function (maybeQuery) {
	if (maybeQuery.$ === 'Just') {
		...
		return A2($elm$core$String$split, ',', query);
	} else {
		return _List_Nil;
	}
};
		...
		if (maybeRoute.$ === 'Nothing') {
			...
			switch (maybeRoute.a.$) {
				case 'Top':
					...
					var maybeMembers = _v1.a;
					var maybeRoles = _v1.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								members: $author$project$Main$queryValueToList(maybeMembers),
								page: $author$project$Main$TopPage,
								roles: $author$project$Main$queryValueToList(maybeRoles)
							}),
						$elm$core$Platform$Cmd$none);
				case 'MemberList':
					...
					if (_v3.a.$ === 'Just') {
						return _Utils_Tuple2(
							_Utils_update(
								...
								{
									members: $author$project$Main$queryValueToList(maybeMembers),
									page: $author$project$Main$MemberListPage,
									roles: $author$project$Main$queryValueToList(maybeRoles)
								}),
							$elm$core$Platform$Cmd$none);
					} else {
...
var $author$project$Route$MemberList = F2(
	function (a, b) {
		return {$: 'MemberList', a: a, b: b};
	});
var $author$project$Route$Reset = {$: 'Reset'};
			...
			A2(
				...
				A2(
					...
					A2(
						...
						$elm$url$Url$Parser$Query$string('members')),
					$elm$url$Url$Parser$Query$string('roles')))),
			A2(
			$elm$url$Url$Parser$map,
				...
				if (target.$ === 'Member') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								members: A2($elm$core$List$cons, '', model.members)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								roles: A2($elm$core$List$cons, '', model.roles)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'UpdateInput':
				...
				if (target.$ === 'Member') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								members: A3($elm_community$list_extra$List$Extra$setAt, n, value, model.members)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								roles: A3($elm_community$list_extra$List$Extra$setAt, n, value, model.roles)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'DeleteInput':
				...
				if (target.$ === 'Member') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								members: A2($elm_community$list_extra$List$Extra$removeAt, n, model.members)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								roles: A2($elm_community$list_extra$List$Extra$removeAt, n, model.roles)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'Shuffled':
												...
												[
													...
													_List_fromArray(
														[
															...
															$elm$html$Html$Attributes$class('fa-times')
														]),
													_List_Nil)
												]))
										]))
		...
		body: _List_fromArray(
			[
				...
				switch (_v0.$) {
					...
					case 'IllegalPage':
						return $author$project$Main$viewIllegalPage;
					case 'TopPage':
						return $author$project$Main$viewTopPage(model);
					default:
						return $author$project$Main$viewMemberListPage(model);
				}
			}()
			]),
